              ...
              <div class="d-flex justify-content-end">
                ...
                <div class="media helpInfo">
                  ...
                  <div class="media-body">
                    ...
                    <p class="subText">Uttara-1230, Dhaka</p>
                  </div>
                </div>
              </div>
            </div>
...
{{--
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item nav-btn">
                    <a class="nav-link js-scroll-trigger" href="{{url('take/doctor/appoinment')}}">
                    ...
                    <div class="col-md-12">
                      <div class="slide-text text-center">
                        ...
                        <div class="service-icon d-flex justify-content-center">
                          <div class="icon-box" data-toggle="tooltip" data-placement="top" title="Cardiology">
                            <i class="flaticon-heart"></i>
                          </div>
                          <div class="icon-box" data-toggle="tooltip" data-placement="top" title="Gynaecology">
    ...
    <footer class="main-footer footer-dark" id="contact_html">
        ...
        <p class="des">
            Thank you for considering our clinic for you and your family’s dental needs. We are pleased to welcome you as a new patient and look forward to being of service to you. We provide a full range of general, preventive and cosmetic dental treatments in a relaxed atmosphere, using the latest technology.
        </p>
        ...
        <li>
          <a href="{{url('/doctor/by/deparmtent/1')}}">Cardiology</a>
        </li>
        <li>
          <a href="{{url('/doctor/by/deparmtent/2')}}">Gynaecology</a>
        </li>
        <li>
          <a href="{{url('/doctor/by/deparmtent/4')}}">Pharmacy</a>
        </li>
        <li>
          <a href="{{url('/doctor/by/deparmtent/10')}}">Pregnancy</a>
        </li>
        <li>
          <a href="{{url('/doctor/by/deparmtent/5')}}">Psychology</a>
        </li>
        <li>
          <a href="{{url('/doctor/by/deparmtent/6')}}">Radiotherapy</a>
        </li>
        <li>
        <a href="{{url('/doctor/by/deparmtent/7')}}">Surgery</a>
        </li>
        <li>
        <a href="{{url('/doctor/by/deparmtent/8')}}">Therapy</a>
        </li>
        </ul>
        </div>
        </div>
        ...
        <p>
            Sector-4, Road-4, House-19, Uttara-1230, Dhaka
        </p>
        <ul class="list-unstyled">
        <li>
          <i class="ti-mobile"></i>
          Phone No:
          <a href="">(+88)-01674854016</a>
        </li>
        <li>
          <i class="icon-mobile"></i>
          Text:
        ...
        <li>
          ...
          <a href="demo%40hospital.html" class="linkUnderlined">
            <span class="__cf_email__" data-cfemail="ceaaaba3a18ea6a1bdbea7baafa2e0ada1a3">ratnabiswas556@gmail.com</span></a>
        </li>
