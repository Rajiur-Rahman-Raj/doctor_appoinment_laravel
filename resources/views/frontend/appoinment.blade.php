...
<script>
	$(document).ready(function() {
		$('#doctor_id').on('change', function() {
			...
			if (dist_id) {
				$.ajax({
					url: '/findDateWithDoctor/' + dist_id,
					type: "GET",
					data: {
						"_token": "{{ csrf_token() }}"
					},
					...
					success: function(data) {
						...
						if (data) {
							$('#date_id').empty();
							$('#date_id').focus;
							$('#date_id').append('<option value="">-- Select Date --</option>');
							$.each(data, function(key, value) {
...
<script>
	$(document).ready(function() {
		$('#doctor_id').on('change', function() {
			...
			if (dist_id) {
				$.ajax({
					url: '/findtimeWithDoctor/' + dist_id,
					type: "GET",
					data: {
						"_token": "{{ csrf_token() }}"
					},
					...
					success: function(data) {
						...
						if (data) {
							$('#time_id').empty();
							$('#time_id').focus;
							$('#time_id').append('<option value="">-- Select Time --</option>');
							$.each(data, function(key, value) {
