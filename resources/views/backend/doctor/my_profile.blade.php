                                ...
                                <div class="col-lg-8">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label>Contact :</label>
                                                <input type="text" name="contact" class="form-control" value="@if($doctors_info != null) {{$doctors_info->contact}} @endif" placeholder="01*********" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <select name="category_id" class="form-control" required>
                                                    <option value="@if($doctors_info != null) {{$doctors_info->category_id}} @endif">Select One</option>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <label>Degree :</label>
                                                <textarea name="degree" class="form-control" placeholder="Professional Degree" required>@if($doctors_info != null) {{$doctors_info->degree}} @endif</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
