    ...
    <section>
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card mt-3">
                        <div class="card-header rounded bg-danger text-white">
                            <b><i class="far fa-calendar-times"></i> Cancelled Appoinments</b>
                        </div>
                        <div class="card-body">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{url('delete/cancelled/appoinments/by/doctor')}}/{{$detail->slug}}" class="btn btn-sm btn-danger rounded">Delete</a>
                                        </td>
                                    </tr>
                                    <?php $sl++ ?>
                                    @endforeach
