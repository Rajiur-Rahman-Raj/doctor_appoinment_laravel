                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{url('delete/recent/approved')}}/{{$detail->slug}}" class="btn btn-sm btn-danger rounded">Cancel</a>
                                            <a href="{{url('print/recent/approved')}}/{{$detail->slug}}" class="btn btn-sm btn-info rounded"><i class="fas fa-print"></i></a>
                                        </td>
                                    </tr>
                                    <?php $sl++ ?>
                                    @endforeach
