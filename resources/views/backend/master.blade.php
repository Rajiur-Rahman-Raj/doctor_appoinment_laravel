          ...
          <ul id="side-main-menu" class="side-menu list-unstyled">
            ...
            <li><a href="#exampledropdownDropdown1" aria-expanded="false" data-toggle="collapse">  <i class="fas fa-users"></i>User's List</a>
                <ul id="exampledropdownDropdown1" class="collapse list-unstyled ">
                    <li><a href="{{url('doctor/list/for/admin')}}"><i class="fas fa-user-md"></i> Doctor's List <b class="text-success" style="font-weight:800">( {{App\Doctor::count()}} )</b></a></li>
                    <li><a href="{{url('patient/list')}}"><i class="fas fa-user-injured"></i> Patient's List <b class="text-info" style="font-weight:800">( {{App\Patient::count()}} )</b></a></li>
                </ul>
            </li>
            ...
            ?>
            <li><a href="{{url('recent/approved/appoinment/for/admin')}}"> <i class="far fa-clock"></i>Recent Approved <span class="text-success"><h5>({{$recent_approved}})</h5></span></a></li>
            <?php
                $date = date('Y-m-d H:i:s');
                $current_date = Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $date)->format('Y-m-d');
                $pending_appoinments = DB::table('appoinments')->where('status',0)->where('appoinment_date','>=',$current_date)->count();
            ?>
            <li><a href="{{url('pending/list/appoinment/for/admin')}}"> <i class="fas fa-user-clock"></i>Pending List <span class="text-warning"><h5>({{$pending_appoinments}})</h5></span></a></li>
            <?php
                $date = date('Y-m-d H:i:s');
                $current_date = Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $date)->format('Y-m-d');
                $prev_approved = DB::table('appoinments')->where('status',1)->where('appoinment_date','<',$current_date)->count();
            ?>
            <li><a href="{{url('previous/approved/appoinment/by/admin')}}"> <i class="fas fa-history"></i>Previous Approved <span class="text-info"><h5>({{$prev_approved}})</h5></span></a></li>
            <?php
                $date = date('Y-m-d H:i:s');
                $current_date = Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $date)->format('Y-m-d');
                $cancelled = DB::table('appoinments')->where('status',0)->where('appoinment_date','<',$current_date)->count();
            ?>
            <li><a href="{{url('cancelled/appoinment/by/admin')}}"> <i class="far fa-calendar-times"></i>Cancelled List <span class="text-danger"><h5>({{$cancelled}})</h5></span></a></li>

            <li><a href="{{url('doctor/list/pdf')}}"> <i class="fas fa-file-alt"></i>Doctor List PDF <b class="text-success" style="font-weight:800">({{App\Doctor::count()}})</b></a></li>
            <li><a href="{{url('patient/list/pdf')}}"> <i class="far fa-file-alt"></i>Patient List PDF <b class="text-info" style="font-weight:800">({{App\Patient::count()}})</b></a></li>
            ...
            @if(Auth::user()->user_type == "doctor")
                ...
                ?>
                <li><a href="{{url('previous/approved/appoinment/by/doctor')}}"> <i class="fas fa-history"></i>Previous Approved <span class="text-info"><h5>({{$prev_approved}})</h5></span></a></li>
                <?php
                    $date = date('Y-m-d H:i:s');
                    $current_date = Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $date)->format('Y-m-d');
            ...
            @if(Auth::user()->user_type == "patient")
                ...
                ?>
                <li><a href="{{url('recent/approved/appoinment')}}"> <i class="far fa-clock"></i>Recent Approved <span class="text-success"><h5>({{$recent_approved}})</h5></span></a></li>
                <?php
                    $date = date('Y-m-d H:i:s');
                    $current_date = Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $date)->format('Y-m-d');
                ...
                ?>
                <li><a href="{{url('pending/list/appoinment')}}"> <i class="fas fa-user-clock"></i>Pending List <span class="text-warning"><h5>({{$pending_appoinments}})</h5></span></a></li>
                <?php
                    $date = date('Y-m-d H:i:s');
                    $current_date = Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $date)->format('Y-m-d');
                    $prev_approved = DB::table('appoinments')->where('patient_id',Auth::user()->id)->where('status',1)->where('appoinment_date','<',$current_date)->count();
                ?>
                <li><a href="{{url('previous/approved/appoinment')}}"> <i class="fas fa-history"></i>Previous Approved <span class="text-info"><h5>({{$prev_approved}})</h5></span></a></li>
                <?php
                    $date = date('Y-m-d H:i:s');
                    $current_date = Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $date)->format('Y-m-d');
                    $cancelled = DB::table('appoinments')->where('patient_id',Auth::user()->id)->where('status',0)->where('appoinment_date','<',$current_date)->count();
                ?>
                <li><a href="{{url('cancelled/appoinment')}}"> <i class="far fa-calendar-times"></i>Cancelled List <span class="text-danger"><h5>({{$cancelled}})</h5></span></a></li>
            @endif
